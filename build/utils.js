 ...
 */
function synchronizeLayoutWithChildren(initialLayout, children, cols, compactType, initialLayoutItem) {
  ...
  _react2.default.Children.forEach(children, function (child, i) {
    ...
    if (exists) {
      ...
      if (g) {
        ...
        var layoutItem = initialLayoutItem ? _extends({}, defaultLayoutItem, initialLayoutItem) : defaultLayoutItem;
