...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (newLayoutBase) {
      var newLayout = (0, _utils.synchronizeLayoutWithChildren)(newLayoutBase, nextProps.children, nextProps.cols, this.compactType(nextProps), nextProps.initialLayoutItem);
...
ReactGridLayout.propTypes = {
  ...
  initialLayoutItem: _propTypes2.default.shape({
...
var _initialiseProps = function _initialiseProps() {
  this.state = {
    ...
    this.compactType(), this.props.initialLayoutItem),
    mounted: false,
    oldDragItem: null,
    oldLayout: null,
    oldResizeItem: null
